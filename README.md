...
- 立直 / 役牌三 (連風 2 翻) / 斷么 / 寶牌 → 整數翻
- 七對子路線 (+2)、混一色 (+3/+2)、清一色 (+6/+5)、對對和路線 (+2)
- 一通 (+2/+1)、三色 (+2/+1)、一盃口 (門清 +1)
- 自摸期望 (~25%)、裏寶期望 (立直線 +0.5)、平和可能 (+0.3)、役牌候補對子 → 分數翻
- 副露資訊可用時,副露含么九會取消斷么判定
- 最後向上取整給整數翻數
